...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--task", type=str, choices=["rope", "cloth", "bear"], default="bear")
    parser.add_argument(
        "--dataset-root",
        type=str,
    ...
    parser.add_argument("--current-pcd", type=str, default="source_bear/object.ply", help="Current object point cloud file")
    parser.add_argument("--target-pcd", type=str, default="target_bear/object.ply", help="Target object point cloud file")
    ...
    parser.add_argument(
        "--video-calibrate-pkl",
        type=str,
        default="source_bear/calibrate.pkl",
    ...
    parser.add_argument(
        ...
        type=str,
        default="source_bear/intrinsics.npy",
        help="Path to intrinsics.npy for rollout video camera intrinsic (required for camera-matched rendering)",
    )
    parser.add_argument(
        "--video-overlay-image",
        type=str,
        default="source_bear/color.png",
        help="RGB image path for white-background compositing (default: source_bear/color.png)",
    )
    parser.add_argument(
        "--mock-saved-pose",
        type=str,
